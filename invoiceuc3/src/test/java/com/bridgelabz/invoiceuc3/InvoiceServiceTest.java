package com.bridgelabz.invoiceuc3;
...
public class InvoiceServiceTest {
	...
	public void givenDistanceAndTime_ShouldReturnTotalFare() {
		...
		int time  = 5;
		int time1 = 5;
		double fare = invoiceGenerator.calculateFare(distance, time1);
	...
	public void givenMultipleRides_ShouldReturnTotalFare() {
		...
		double fare = invoiceGenerator.calculateMultipleRidesFare(rides1);
